...
function warningMacRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of warningMacComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function PracticeScreen_1RoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of PracticeScreen_1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function typingLoopPractLoopBegin(typingLoopPractLoopScheduler) {
  ...
  for (const thisTypingLoopPract of typingLoopPract) {
...
function typingRTrialLoopBegin(typingRTrialLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisTypingRTrial of typingRTrial) {
...
function TaskOrderCondLoopBegin(TaskOrderCondLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisTaskOrderCond of TaskOrderCond) {
...
function multiLoopPracLoopBegin(multiLoopPracLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisMultiLoopPrac of multiLoopPrac) {
...
function multiRTrialLoopBegin(multiRTrialLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisMultiRTrial of multiRTrial) {
...
function audioLoopPracLoopBegin(audioLoopPracLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisAudioLoopPrac of audioLoopPrac) {
...
function audioCondLoopLoopBegin(audioCondLoopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisAudioCondLoop of audioCondLoop) {
...
function audioRTrialLoopBegin(audioRTrialLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisAudioRTrial of audioRTrial) {
...
function audioCondLoopwaisLoopBegin(audioCondLoopwaisLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisAudioCondLoopwai of audioCondLoopwais) {
...
function audioRTrialwaisLoopBegin(audioRTrialwaisLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisAudioRTrialwai of audioRTrialwais) {
...
function vptLoopPracLoopBegin(vptLoopPracLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisVptLoopPrac of vptLoopPrac) {
...
function TypingPracRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of TypingPracComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function TypingFeedbackRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of TypingFeedbackComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function BeginTrialScreenRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of BeginTrialScreenComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function BreakTimeRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of BreakTimeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function MultiplyScreenRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of MultiplyScreenComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function MultiplyPracRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of MultiplyPracComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function MultiplyFeedbackRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of MultiplyFeedbackComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function AdjustSoundInstRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of AdjustSoundInstComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function AdjustSoundVolRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of AdjustSoundVolComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function AuditoryScreenRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of AuditoryScreenComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Audio_PlayRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of Audio_PlayComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function AuditoryPracticeSetRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of AuditoryPracticeSetComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function AuditoryFeedbackRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of AuditoryFeedbackComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function countingCWRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of countingCWComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function AuditoryTrialssRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of AuditoryTrialssComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function audio_PlayWAISRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of audio_PlayWAISComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function audioTrial_WAISRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of audioTrial_WAISComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function vptScreenRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of vptScreenComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function patternGridRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of patternGridComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function respGridPracRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of respGridPracComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function vptFeedbackRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of vptFeedbackComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function counterRoutineRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of counterRoutineComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function responseGridRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of responseGridComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
